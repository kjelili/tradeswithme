...
export const metadata: Metadata = {
  ...
  title: { default: "TradesWithMe V4.1.1 — Autonomous Learning Observatory", template: "%s | TradesWithMe" },
  ...
  openGraph: { title: "TradesWithMe V4.1.1 — Autonomous Learning Observatory", description: "Autonomous settle → train → scan cycles with a Learning Observatory, bounded adaptive weights, drift control, verified data and evidence-gated paper planning.", url: siteUrl, siteName: "TradesWithMe", type: "website" },
};
